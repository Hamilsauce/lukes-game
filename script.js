...
export class UI {
  ...
  generateNewRando() {
    this.setButtonValue(randInt(1, 1000));
  ...
  setButtonValue(v) {
    ...
    this.trashButton.dataset.hide = (isNaN(+v) || !this.retriesLeft) ? true : false;
  };
